...
#define GIF_SET_TAG(nloop, eop, pre, prim, flg, nreg)( (u64)(nloop) | ((u64)(eop)<<15) | ((u64)(pre) << 46) |	((u64)(prim)<<47) | ((u64)(flg)<<58) | ((u64)(nreg)<<60) )
...
#define GS_SET_RGBA(r, g, b, a) ((u64)(r)        | ((u64)(g) << 8) | ((u64)(b) << 16) | ((u64)(a) << 24))
...
#define GS_SET_FRAME(fbp, fbw, psm, fbmask) ( (u64)(fbp) | (u64)((u64)(fbw) << 16) | (u64)((u64)(psm) << 24) | (u64)((u64)(fbmask) << 32) )

#define GS_SET_XYOFFSET(ofx, ofy) ((u64)(ofx) | ((u64)(ofy) << 32))

#define GS_SET_ZBUF(zbp, psm, zmsk) ( (u64)(zbp) | ((u64)(psm) << 24) | ((u64)(zmsk) << 32) )

#define GS_SET_TEST(ate, atst, aref, afail, date, datm, zte, ztst)	( (u64)(ate)         | ((u64)(atst) << 1) | ((u64)(aref) << 4)  | ((u64)(afail) << 12) | ((u64)(date) << 14) | ((u64)(datm) << 15) | ((u64)(zte) << 16)  | ((u64)(ztst) << 17) )

#define GS_SET_SCISSOR(scax0, scax1, scay0, scay1) 	( (u64)(scax0) | ((u64)(scax1) << 16) | ((u64)(scay0) << 32) | ((u64)(scay1) << 48) )

#define GS_SET_PRIM(prim, iip, tme, fge, abe, aa1, fst, ctxt, fix) 	((u64)(prim)      | ((u64)(iip) << 3)  | ((u64)(tme) << 4) | ((u64)(fge) << 5) | ((u64)(abe) << 6)  | ((u64)(aa1) << 7) | ((u64)(fst) << 8) | ((u64)(ctxt) << 9) | ((u64)(fix) << 10))

#define GS_SET_DISPFB(fbp, fbw, psm, dbx, dby) 	((u64)(fbp) | ((u64)(fbw) << 9) | ((u64)(psm) << 15) | ((u64)(dbx) << 32) | ((u64)(dby) << 43))

#define GS_SET_BITBLTBUF(sbp, sbw, spsm, dbp, dbw, dpsm) ((u64)(sbp)         | ((u64)(sbw) << 16) |	((u64)(spsm) << 24) | ((u64)(dbp) << 32) | ((u64)(dbw) << 48)  | ((u64)(dpsm) << 56))

#define GS_SET_TRXDIR(xdr) ((u64)(xdr))

#define GS_SET_TRXPOS(ssax, ssay, dsax, dsay, dir) 	((u64)(ssax)        | ((u64)(ssay) << 16) | ((u64)(dsax) << 32) | ((u64)(dsay) << 48) | ((u64)(dir) << 59))

#define GS_SET_TRXREG(rrw, rrh) ((u64)(rrw) | ((u64)(rrh) << 32))

#define GS_SET_TEX0(tbp, tbw, psm, tw, th, tcc, tfx, cbp, cpsm, csm, csa, cld)	((u64)(tbp)         | ((u64)(tbw) << 14) | ((u64)(psm) << 20)  | ((u64)(tw) << 26) | ((u64)(th) << 30)   | ((u64)(tcc) << 34) | ((u64)(tfx) << 35)  | ((u64)(cbp) << 37) | ((u64)(cpsm) << 51) | ((u64)(csm) << 55) | ((u64)(csa) << 56)  | ((u64)(cld) << 61))

#define GS_SET_CLAMP(wms, wmt, minu, maxu, minv, maxv) ((u64)(wms)         | ((u64)(wmt) << 2) | ((u64)(minu) << 4)  | ((u64)(maxu) << 14) | ((u64)(minv) << 24) | ((u64)(maxv) << 34))
...
#define DMA_SET_TAG(qwc,pce,id,irq,next)   ( (u64)(qwc) | ((u64)(pce) << 16) | ((u64)(id) << 28) | ((u64)(irq) << 31) | ((u64)(next) << 32) )
